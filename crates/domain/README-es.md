...
- [Doc/Arquitectura-es.md](../../Doc/Arquitectura-es.md) — decisiones D1–D12, fronteras de dominio
- [Doc/Casos-de-Uso-ER-Flujos-es.md](../../Doc/Casos-de-Uso-ER-Flujos-es.md) — UC-01–UC-11
