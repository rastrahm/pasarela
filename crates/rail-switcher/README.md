...
- [Doc/Arquitectura.md](../../Doc/Arquitectura.md) — decisión D3, diagrama Rail Switcher
- [Doc/Casos-de-Uso-ER-Flujos.md](../../Doc/Casos-de-Uso-ER-Flujos.md) — UC-02, UC-08
- [domain/README.md](../domain/README.md) — tipos compartidos
