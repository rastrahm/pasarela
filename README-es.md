...
> **Idiomas:** variantes [`-es`](Doc/Documentation-i18n-es.md) y [`-en`](Doc/Documentation-i18n-en.md). Índice: [Documentation-i18n-es.md](Doc/Documentation-i18n-es.md) · [Documentation-i18n-en.md](Doc/Documentation-i18n-en.md).

### Diseño y planificación

| Documento | Contenido |
|-----------|-----------|
| [Doc/Arquitectura-es.md](Doc/Arquitectura-es.md) | Componentes, seguridad, fronteras, decisiones D1–D12 |
| [Doc/Casos-de-Uso-ER-Flujos-es.md](Doc/Casos-de-Uso-ER-Flujos-es.md) | Casos de uso UC-01–UC-11, ER, diagramas de flujo |
| [Doc/Contexto General-es.md](Doc/Contexto%20General-es.md) | Contexto del producto y reglas de confirmación por fase |
| [Doc/Plan-de-Implementacion-es.md](Doc/Plan-de-Implementacion-es.md) | Hoja de ruta por fases (0–8) y estado actual |

### Operación y deploy

| Documento | Contenido |
|-----------|-----------|
| [Doc/Runbook-Desarrollo-es.md](Doc/Runbook-Desarrollo-es.md) | Stack local sin contenedores |
| [Doc/Runbook-Staging-es.md](Doc/Runbook-Staging-es.md) | Staging Docker + Caddy |
| [Doc/Provision-VPS-Fase-7-es.md](Doc/Provision-VPS-Fase-7-es.md) | Checklist VPS y primer deploy |
| [Doc/CI-es.md](Doc/CI-es.md) | GitHub Actions (Rust, frontend, Playwright, build staging) |

### Calidad y deuda

| Documento | Contenido |
|-----------|-----------|
| [Doc/Pruebas-es.md](Doc/Pruebas-es.md) | Pirámide de tests y regresión |
| [Doc/Checklist-QA-Fase-6-es.md](Doc/Checklist-QA-Fase-6-es.md) | QA funcional UC-01–UC-11 |
| [Doc/Revision-Seguridad-Fase-6-es.md](Doc/Revision-Seguridad-Fase-6-es.md) | Revisión OWASP / PCI |
| [Doc/Revision-Rendimiento-Fase-6-es.md](Doc/Revision-Rendimiento-Fase-6-es.md) | Presupuestos de latencia |
| [Doc/Deuda-Tecnica-es.md](Doc/Deuda-Tecnica-es.md) | Registro P0–P3 |
| [Doc/Cierre-Deuda-Fase-6.8-es.md](Doc/Cierre-Deuda-Fase-6.8-es.md) | Cierre deuda crítica pre-staging |

### Actas de cierre por fase

[Fase 0](Doc/Acta-Cierre-Fase-0-es.md) · [Fase 1](Doc/Acta-Cierre-Fase-1-es.md) · [Fase 2](Doc/Acta-Cierre-Fase-2-es.md) · [Fase 4](Doc/Acta-Cierre-Fase-4-es.md) · [Fase 5](Doc/Acta-Cierre-Fase-5-es.md)

### READMEs por servicio

[`oracle/`](oracle/README-es.md) · [`crates/domain/`](crates/domain/README-es.md) · [`crates/rail-switcher/`](crates/rail-switcher/README-es.md) · [`crates/api-gateway/`](crates/api-gateway/README-es.md) · [`antifraud/`](antifraud/README-es.md) · [`binance-sim/`](binance-sim/README-es.md) · [`frontend/`](frontend/README-es.md) · [`programs/payment-settlement/`](programs/payment-settlement/README-es.md) · [`deploy/staging/`](deploy/staging/README-es.md)
